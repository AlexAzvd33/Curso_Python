...
while org_chutes != org_bolas:
    ...
    print("Suas Bolas (em ordem crescente)     :", org_chutes[0], org_chutes[1], org_chutes[2], org_chutes[3],
          org_chutes[4], org_chutes[5])
    print("Bolas Sorteadas (em ordem crescente):", org_bolas[0], org_bolas[1], org_bolas[2], org_bolas[3], org_bolas[4],
          org_bolas[5])
    print("")
